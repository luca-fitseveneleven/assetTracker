      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-6">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button type="button" variant="outline" onClick={() => { if (!isDirty || confirm("Discard unsaved changes?")) router.back(); }}>Cancel</Button>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button variant="default" type="submit" disabled={saving || usernameTaken || emailTaken}>{saving ? "Saving..." : "Save"}</Button>
        </div>
      </form>
    </div>
  );
